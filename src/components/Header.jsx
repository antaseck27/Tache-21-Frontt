...
export default function Header({ onOpenSidebar, darkMode, setDarkMode }) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-white text-[#f1e8dc] dark:bg-[#3a2e2a]  border-[#cbb99a] dark:bg-[#3a2e2a]  border-[#cbb99a] dark:border-[#b19b7a] text-[#6b5a49] dark:text-[#f1e8dc]">
