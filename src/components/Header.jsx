        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative" ref={profileRef}>
            <button
              ...
              className="flex items-center gap-2 px-2 sm:px-3 py-1.5
              text-sm font-medium rounded-full bg-[#e8dcc7] text-[#6b5a49]
              hover:bg-[#d6c5a9]
              dark:bg-[#b19b7a] dark:text-[#f1e8dc] dark:hover:bg-[#9c8b73]
              transition "
            >
              <span className="w-7 h-7 rounded-full bg-[#cbb99a] dark:bg-[#8f7e6b] flex items-center justify-center text-white text-xs sm:text-sm">
                M
              </span>
            ...
            {openProfile && (
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#222] border border-gray-300 dark:border-gray-700 rounded-md shadow-md overflow-hidden z-50">
                ...
                <Link
                  to="/profile"
                  className="block px-4 py-3 text-sm hover:bg-[#d6c5a9] dark:hover:bg-[#3a3a3a] border-y border-gray-200 dark:border-gray-700"
                  onClick={() => setOpenProfile(false)}
                >
                  Profil
                </Link>
