...
<div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-r from-[#bfa98a] to-[#d6c5a9] flex items-center justify-center text-white font-semibold shadow-sm">BR</div>
...
<button onClick={() => setOpenProfile(p => !p)} className="flex items-center gap-2 px-2 sm:px-3 py-1.5 text-sm font-medium rounded-full bg-[#e8dcc7] text-[#6b5a49] hover:bg-[#d6c5a9] dark:bg-[#b19b7a] dark:text-[#f1e8dc] dark:hover:bg-[#9c8b73]">
