    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white dark:bg-[#3a2e2a]  border-[#cbb99a] dark:border-[#b19b7a]">
      <div className="max-w-[1400px] mx-auto flex items-center h-20 px-4 gap-3">
        ...
        <button
          ...
          className="p-2 rounded md:hidden hover:bg-gray-100 dark:hover:bg-[#b19b7a]"
        >
          <Bars3Icon className="w-8 h-8 text-[#6b5a49] dark:text-[#f1e8dc]" />
        </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={toggleDark}
            className="p-2 rounded-full hover:bg-[#e8dcc7] dark:hover:bg-[#b19b7a]"
          >
            {darkMode ? (
              <SunIcon className="w-5 h-5 text-yellow-400" />
            ) : (
              <MoonIcon className="w-5 h-5 text-[#6b5a49]" />
            )}
          </button>
          ...
          <div className="relative" ref={notifRef}>
            <button
              ...
              className="p-2 rounded-full hover:bg-[#e8dcc7] dark:hover:bg-[#b19b7a] relative"
            >
              <BellIcon className="w-5 h-5 text-[#6b5a49]" />
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-red-600 text-white text-xs rounded-full px-1.5">
                  {unreadCount}
                </span>
            ...
            {openNotif && (
              <div className="absolute right-0 mt-2 w-64 max-h-80 overflow-y-auto bg-white dark:bg-[#222] border rounded shadow z-50">
                {notifications.length === 0 ? (
          ...
          <div className="relative" ref={profileRef}>
            <button
              onClick={() => setOpenProfile((p) => !p)}
              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#e8dcc7] hover:bg-[#d6c5a9]"
            >
              <img
