...
<aside className="hidden md:fixed md:inset-y-0 md:left-0 md:w-72 md:bg-white md:p-6 md:overflow-y-auto md:flex md:flex-col dark:md:bg-[#0f0f0f]   bg-white dark:bg-[#1a1a1a]
">
<div>
