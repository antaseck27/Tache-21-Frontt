...
//   const heroImages = [
//     "https://i.pinimg.com/736x/bd/c6/24/bdc6247d1c8ebafd95db73f665adabd4.jpg", // Fatou
//     "https://i.pinimg.com/736x/69/d9/40/69d94014cf6076c43bc78d78d961faf6.jpg", // Mamadou
//     "https://i.pinimg.com/736x/51/53/80/515380751129888674.jpg", // Awa
//   ];
...
//           style={{
//             background:
//               "linear-gradient(90deg, rgba(212, 188, 156, 0.94), rgba(191,169,138,0.75))",
//           }}
//         />
...
//               img: "https://i.pinimg.com/736x/a8/ba/96/a8ba9626de3fadff0b38e1c83cdea435.jpg",
//             },
//             {
//               name: "Awa Diop",
...
//         <h2 className="text-4xl font-bold text-var(--gradient-beige-brown)">
//           Prêt à rejoindre BankRewmi ?
//         </h2>
//         <p className="text-[#6b5a49] mt-3 text-lg">Ouvrez votre compte en 2 minutes.</p>

//         <Link
//           to="/signup"
//           className="mt-6 inline-block px-8 py-3 bg-[#bfa98a] text-white font-semibold rounded-xl shadow-lg"
//         >
...
//       {/* ======================= FOOTER ======================= */}
//       <footer className="py-6 text-center text-[#7a6b5c] border-t bg-white">
