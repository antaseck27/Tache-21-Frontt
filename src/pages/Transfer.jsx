...
//         <h2 className="text-3xl font-bold mb-2">Transfert d'argent</h2>
...
//                 <p className="text-xs text-beige-900">Transfert entre vos comptes</p>
//               </h2>
...
//   return (
//     <div className="min-h-screen p-6 bg-[#f7f3ee] text-[#6b5a49]">
//       {/* Header */}
//       <div className="max-w-6xl mx-auto text-center mb-8">
//         <h2 className="text-3xl font-bold mb-2">Transfert d'argent</h2>
//         <p className="text-[#8f7e6b] text-lg">
//           Envoyez de l'argent à vos proches ou payez vos factures
//         </p>
//       </div>
...
//       <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
//         {/* Formulaire */}
//         <div className="md:col-span-2 bg-[#fcfaf8] p-8 rounded-xl shadow-lg border border-[#e7ded5]">

//           {/* Onglets */}
//           <div className="flex mb-6">
//             <div className="border border-[#d6c7b8] rounded-xl w-full flex bg-[#e9e0d7]">
//               <button
//                 onClick={() => setActiveTab("interne")}
//                 className={`px-4 py-2 rounded-lg text-sm font-medium w-1/2 transition 
//                 ${activeTab === "interne" ? "bg-[#fcfaf8] text-[#6b5a49]" : "text-[#8f7e6b]"}`}>
//                 Transfert interne
//               </button>
...
//                 onClick={() => setActiveTab("externe")}
//                 className={`px-4 py-2 rounded-lg text-sm font-medium w-1/2 transition 
//                 ${activeTab === "externe" ? "bg-[#fcfaf8] text-[#6b5a49]" : "text-[#8f7e6b]"}`}>
//                 Transfert externe
//               </button>
//             </div>
//           </div>
...
//               <h2 className="text-xl font-semibold mb-6">
//                 Transfert entre vos comptes
//                 <p className="text-xs text-[#b9a896]">Transfert rapide et instantané</p>
//               </h2>

//               <form className="space-y-4">
//                 {/* Compte source */}
//                 <div>
//                   <label className="block text-[#6b5a49] mb-1">Compte source</label>
//                   <select className="w-full p-3 border border-[#d6c7b8] rounded-xl focus:ring-2 focus:ring-[#b9a896] transition">
//                     <option>Compte Courant - 850 000 FCFA</option>
//                     <option>Compte Épargne - 2 430 000 FCFA</option>
//                   </select>
//                 </div>
...
//                 {/* Compte destination */}
//                 <div>
//                   <label className="block text-[#6b5a49] mb-1">Compte destination</label>
//                   <select className="w-full p-3 border border-[#d6c7b8] rounded-xl focus:ring-2 focus:ring-[#b9a896] transition">
//                     <option>Sélectionnez un compte</option>
//                     <option>Compte Courant - 850 000 FCFA</option>
//                   </select>
...
//                 {/* Montant */}
//                 <div>
//                   <label className="block text-[#6b5a49] mb-1">Montant (FCFA)</label>
//                   <input
//                     type="number"
//                     className="w-full p-3 border border-[#d6c7b8] rounded-xl focus:ring-2 focus:ring-[#b9a896] transition"
//                     placeholder="0"
//                     min="0"
//                   />
//                 </div>
...
//                 {/* Description */}
//                 <div>
//                   <label className="block text-[#6b5a49] mb-1">Description (optionnel)</label>
//                   <input
//                     type="text"
//                     className="w-full p-3 border border-[#d6c7b8] rounded-xl focus:ring-2 focus:ring-[#b9a896] transition"
//                     placeholder="Ex: Épargne mensuelle"
...
//                 <button className="w-full bg-gradient-to-r from-[#b9a896] to-[#8f7e6b] text-[#f7f3ee] p-3 rounded-xl font-semibold hover:opacity-90 transition">
//                   Envoyer
//                 </button>
//               </form>
//             </div>
...
//               <h2 className="text-xl font-semibold mb-6">
//                 Transfert externe
//                 <p className="text-xs text-[#b9a896]">Transférez vers un compte externe</p>
//               </h2>
...
//                 {/* IBAN */}
//                 <div>
//                   <label className="block text-[#6b5a49] mb-1">IBAN</label>
//                   <select className="w-full p-3 border border-[#d6c7b8] rounded-xl focus:ring-2 focus:ring-[#b9a896] transition">
//                     <option>Sélectionnez un compte</option>
//                     <option>Compte Courant - 850 000 FCFA</option>
//                   </select>
...
//         <div className="space-y-6">
//           {/* Contacts récents */}
//           <div className="bg-[#fcfaf8] p-5 rounded-xl shadow border border-[#e7ded5]">
//             <h3 className="text-lg font-semibold mb-3">Contacts récents</h3>

//             <ul className="space-y-3">
//               {contacts.map((c, i) => (
//                 <li key={i} className="flex items-center gap-3">
//                   <i className={`${c.icon} text-[#8f7e6b] text-xl`}></i>
//                   <div>
//                     <p className="font-semibold text-[#6b5a49]">{c.name}</p>
//                     <p className="text-sm text-[#8f7e6b]">{c.email}</p>
//                   </div>
//                 </li>
//               ))}
//             </ul>
...
//               {infos.map((info, i) => (
//                 <li key={i} className="flex items-start gap-3">
//                   <i className={`${info.icon} text-[#8f7e6b] text-xl`}></i>
//                   <div>
//                     <p className="font-semibold text-[#6b5a49]">{info.title}</p>
//                     <p className="text-sm text-[#8f7e6b]">{info.subtitle}</p>
//                   </div>
//                 </li>
//               ))}
//             </ul>
