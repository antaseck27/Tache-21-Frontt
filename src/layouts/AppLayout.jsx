...
export default function AppLayout({ darkMode, setDarkMode }) {
  ...
  // Fermer le sidebar si l'utilisateur clique en dehors du sidebar
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (!e.target.closest('aside') && sidebarOpen) {
  ...
  }, [sidebarOpen]); // Re-render only when sidebarOpen changes
  ...
  useEffect(() => {
    ...
    localStorage.setItem("theme", darkMode ? "dark" : "light"); // Save theme in localStorage
  }, [darkMode]);
